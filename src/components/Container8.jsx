...
const Container8 = () => {
  ...
  return (
    <div  className={isVisible ? "Container8 Container88 showContainer88" : "Container8 Container88"}>
        <div className="yzeiq">
            <div className="uizfd">
                <img src="https://images.squarespace-cdn.com/content/v1/5f5761db3193933cec5cb485/1599570739265-Y8P35RVRNHPIBX6MY1OC/mi6+night.jpg?format=500w" alt="" />
            </div>
        </div>
        <div className="uziqdh">
